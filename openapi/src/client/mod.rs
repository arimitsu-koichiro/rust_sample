    ...
    C: Has<XSpanIdString> + Clone + Send + Sync + 'static,
{
    ...
    async fn get_account(
        ...
        match response.status().as_u16() {
            ...
            0 => {
                ...
                let body = str::from_utf8(&body)
                    .map_err(|e| ApiError(format!("Response was not valid UTF8: {e}")))?;
                let body = serde_json::from_str::<models::ErrorMessage>(body).map_err(|e| {
                    ApiError(format!("Response body did not match the schema: {e}"))
                })?;
                Ok(GetAccountResponse::Status0(body))
            }
            code => {
    ...
    async fn forget_password(
        &self,
        param_forget_password_request: models::ForgetPasswordRequest,
        context: &C,
    ) -> Result<ForgetPasswordResponse, ApiError> {
        let mut client_service = self.client_service.clone();
        let mut uri = format!("{}/api/v1/auth/forget_password", self.base_path);
        ...
        // Body parameter
        let body = serde_json::to_string(&param_forget_password_request)
        ...
        *request.body_mut() = Body::from(body);
        ...
        match response.status().as_u16() {
            200 => {
                ...
                let body = str::from_utf8(&body)
                    .map_err(|e| ApiError(format!("Response was not valid UTF8: {e}")))?;
                let body = serde_json::from_str::<models::StatusOk>(body).map_err(|e| {
                    ApiError(format!("Response body did not match the schema: {e}"))
                })?;
                Ok(ForgetPasswordResponse::OK(body))
            }
            0 => {
                let body = response.into_body();
                let body = body
                ...
                Ok(ForgetPasswordResponse::Status0(body))
            }
            code => {
                let headers = response.headers().clone();
                let body = response.into_body().take(100).into_raw().await;
    ...
    async fn get_auth_status(&self, context: &C) -> Result<GetAuthStatusResponse, ApiError> {
        let mut client_service = self.client_service.clone();
        let mut uri = format!("{}/api/v1/auth/status", self.base_path);
        ...
        match response.status().as_u16() {
            200 => {
                ...
                Ok(GetAuthStatusResponse::OK(body))
            }
            0 => {
                let body = response.into_body();
                let body = body
                ...
                Ok(GetAuthStatusResponse::Status0(body))
            }
            code => {
                let headers = response.headers().clone();
                let body = response.into_body().take(100).into_raw().await;
    ...
    async fn reset_password(
        &self,
        param_reset_password_request: models::ResetPasswordRequest,
        context: &C,
    ) -> Result<ResetPasswordResponse, ApiError> {
        let mut client_service = self.client_service.clone();
        let mut uri = format!("{}/api/v1/auth/reset_password", self.base_path);
        ...
        let body = serde_json::to_string(&param_reset_password_request)
            .expect("impossible to fail to serialize");
        *request.body_mut() = Body::from(body);
        ...
        match response.status().as_u16() {
            200 => {
                ...
                Ok(ResetPasswordResponse::OK(body))
            }
            0 => {
                let body = response.into_body();
                let body = body
                ...
                Ok(ResetPasswordResponse::Status0(body))
            }
            code => {
                let headers = response.headers().clone();
                let body = response.into_body().take(100).into_raw().await;
    ...
    async fn signin(
        &self,
        param_signin_request: models::SigninRequest,
        context: &C,
    ) -> Result<SigninResponse, ApiError> {
        let mut client_service = self.client_service.clone();
        let mut uri = format!("{}/api/v1/auth/signin", self.base_path);
        ...
        let body =
            serde_json::to_string(&param_signin_request).expect("impossible to fail to serialize");
        *request.body_mut() = Body::from(body);
        ...
        match response.status().as_u16() {
            ...
            0 => {
                ...
                Ok(SigninResponse::Status0(body))
            }
            code => {
                let headers = response.headers().clone();
                let body = response.into_body().take(100).into_raw().await;
    ...
    async fn signout(&self, context: &C) -> Result<SignoutResponse, ApiError> {
        let mut client_service = self.client_service.clone();
        let mut uri = format!("{}/api/v1/auth/signout", self.base_path);
        ...
        match response.status().as_u16() {
            ...
            0 => {
                ...
                Ok(SignoutResponse::Status0(body))
            }
            code => {
                let headers = response.headers().clone();
                let body = response.into_body().take(100).into_raw().await;
    ...
    async fn signup(
        &self,
        param_sign_up_request: models::SignUpRequest,
        context: &C,
    ) -> Result<SignupResponse, ApiError> {
        let mut client_service = self.client_service.clone();
        let mut uri = format!("{}/api/v1/auth/signup", self.base_path);
        ...
        let body =
            serde_json::to_string(&param_sign_up_request).expect("impossible to fail to serialize");
        *request.body_mut() = Body::from(body);
        ...
        match response.status().as_u16() {
            ...
            0 => {
                ...
                Ok(SignupResponse::Status0(body))
            }
            code => {
                let headers = response.headers().clone();
                let body = response.into_body().take(100).into_raw().await;
    ...
    async fn signup_finish(
        &self,
        param_sign_up_finish_request: models::SignUpFinishRequest,
        context: &C,
    ) -> Result<SignupFinishResponse, ApiError> {
        let mut client_service = self.client_service.clone();
        let mut uri = format!("{}/api/v1/auth/signup/finish", self.base_path);
        ...
        let body = serde_json::to_string(&param_sign_up_finish_request)
            .expect("impossible to fail to serialize");
        ...
        *request.body_mut() = Body::from(body);
        ...
        match response.status().as_u16() {
            200 => {
                ...
                Ok(SignupFinishResponse::OK(body))
            }
            0 => {
                let body = response.into_body();
                let body = body
                ...
                Ok(SignupFinishResponse::Status0(body))
            }
            code => {
                let headers = response.headers().clone();
                let body = response.into_body().take(100).into_raw().await;
    ...
    async fn channel_cocket(
        ...
        let mut uri = format!(
            ...
            self.base_path,
            channel_id = utf8_percent_encode(&param_channel_id.to_string(), ID_ENCODE_SET)
        );
        ...
        match response.status().as_u16() {
            200 => {
                ...
                Ok(ChannelCocketResponse::OK(body))
            }
            0 => {
                let body = response.into_body();
                let body = body
                ...
                Ok(ChannelCocketResponse::Status0(body))
            }
            code => {
                let headers = response.headers().clone();
                let body = response.into_body().take(100).into_raw().await;
    ...
    async fn publish_channel(
        &self,
        param_channel_id: String,
        param_channel_message: models::ChannelMessage,
        context: &C,
        ...
        let body =
            serde_json::to_string(&param_channel_message).expect("impossible to fail to serialize");
        *request.body_mut() = Body::from(body);
        ...
        match response.status().as_u16() {
            200 => {
                ...
                Ok(PublishChannelResponse::OK(body))
            }
            0 => {
                let body = response.into_body();
                let body = body
                ...
                Ok(PublishChannelResponse::Status0(body))
            }
            code => {
                let headers = response.headers().clone();
                let body = response.into_body().take(100).into_raw().await;
    ...
    async fn subscribe_channel(
        ...
        match response.status().as_u16() {
            200 => {
                ...
                let body = str::from_utf8(&body)
                    .map_err(|e| ApiError(format!("Response was not valid UTF8: {e}")))?;
                let body = serde_json::from_str::<models::ChannelMessage>(body).map_err(|e| {
                    ApiError(format!("Response body did not match the schema: {e}"))
                })?;
                Ok(SubscribeChannelResponse::OK(body))
            }
            0 => {
                let body = response.into_body();
                let body = body
                ...
                Ok(SubscribeChannelResponse::Status0(body))
            }
            code => {
                let headers = response.headers().clone();
                let body = response.into_body().take(100).into_raw().await;
    ...
    async fn get_status(&self, context: &C) -> Result<GetStatusResponse, ApiError> {
        let mut client_service = self.client_service.clone();
        let mut uri = format!("{}/api/v1/status", self.base_path);
        ...
        match response.status().as_u16() {
            200 => {
                ...
                let body = str::from_utf8(&body)
                    .map_err(|e| ApiError(format!("Response was not valid UTF8: {e}")))?;
                let body = serde_json::from_str::<models::StatusResponse>(body).map_err(|e| {
                    ApiError(format!("Response body did not match the schema: {e}"))
                })?;
                Ok(GetStatusResponse::OK(body))
            }
            0 => {
                let body = response.into_body();
                let body = body
                ...
                Ok(GetStatusResponse::Status0(body))
            }
            code => {
                let headers = response.headers().clone();
                let body = response.into_body().take(100).into_raw().await;
